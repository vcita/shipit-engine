...
require 'shipit/predictive_build_commands'
require 'shipit/predictive_git_fetch'
require 'shipit/predictive_build_task_commands'
require 'shipit/predictive_branch_task_commands'
